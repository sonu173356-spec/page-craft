...
export const SAMPLE_PUBLISHED_BOOKS: PublishedBook[] = [
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1518495973542-4542c06a5843?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#0F172A] via-[#1E293B] to-[#334155]',
      accentColor: '#C5A55A',
      textColor: '#F8FAFC',
      fontFamily: 'Playfair Display, serif',
      textureImage: 'https://images.unsplash.com/photo-1518495973542-4542c06a5843?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#0B192C] via-[#1E3E62] to-[#000000]',
      accentColor: '#E2B659',
      textColor: '#FFFFFF',
      fontFamily: 'Playfair Display, serif',
      textureImage: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#3B1E1E] via-[#5C2E2E] to-[#1A0B0B]',
      accentColor: '#D4AF37',
      textColor: '#FDF8F0',
      fontFamily: 'Cinzel, Georgia, serif',
      textureImage: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1506703719100-a0f3a48c0f86?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#0D0221] via-[#0F084B] to-[#26408B]',
      accentColor: '#A6E1FA',
      textColor: '#FFFFFF',
      fontFamily: 'Inter, sans-serif',
      textureImage: 'https://images.unsplash.com/photo-1506703719100-a0f3a48c0f86?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#1B4332] via-[#2D6A4F] to-[#52B788]',
      accentColor: '#D8F3DC',
      textColor: '#FFFFFF',
      fontFamily: 'Playfair Display, serif',
      textureImage: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#050505] via-[#171717] to-[#262626]',
      accentColor: '#DC2626',
      textColor: '#F5F5F5',
      fontFamily: 'Playfair Display, serif',
      textureImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#0F172A] via-[#1E293B] to-[#3B82F6]',
      accentColor: '#60A5FA',
      textColor: '#FFFFFF',
      fontFamily: 'Inter, sans-serif',
      textureImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=900&auto=format&fit=crop',
  ...
  },
  {
    ...
    cover_image_url: 'https://images.unsplash.com/photo-1516541196182-6bdb0516ed27?q=80&w=900&auto=format&fit=crop',
    coverStyle: {
      bgGradient: 'from-[#4A0E17] via-[#8B1A1A] to-[#C5A55A]',
      accentColor: '#FFE5B4',
      textColor: '#FFF9F0',
      fontFamily: 'Playfair Display, serif',
      textureImage: 'https://images.unsplash.com/photo-1516541196182-6bdb0516ed27?q=80&w=900&auto=format&fit=crop',
