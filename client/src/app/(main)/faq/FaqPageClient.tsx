...
const faqs = [
  ...
  { question: 'Do you publish non-English books?', answer: 'Currently, we only offer full publishing services for English-language book interiors, though we are looking to expand in the future.', category: 'General' },
