...
const INITIAL_ORDERS: OrderRequest[] = [
  {
    id: 'ord-1001',
    orderNumber: 'PC-ORD-2026-8801',
    customerName: 'Demo Customer A',
    email: 'demo-customer-1@example.invalid',
    phone: '+1-555-0151',
    items: [
      { title: 'The Silent Echo', quantity: 2, price: 399, format: 'Paperback' },
      { title: 'Whispers of Time', quantity: 1, price: 299, format: 'Hardcover' },
    ],
    totalAmount: 1097,
    paymentMethod: 'UPI',
    paymentStatus: 'Paid',
    orderStatus: 'Pending Approval',
    shippingAddress: '100 Sample Avenue, Suite 1',
    city: 'Bengaluru',
    state: 'Karnataka',
    pincode: '560001',
    orderDate: '2026-03-04 14:22',
  },
  {
    id: 'ord-1002',
    orderNumber: 'PC-ORD-2026-8802',
    customerName: 'Demo Customer B',
    email: 'demo-customer-2@example.invalid',
    phone: '+1-555-0152',
    items: [
      { title: 'Startup Playbook', quantity: 1, price: 499, format: 'eBook' },
    ],
    totalAmount: 499,
    paymentMethod: 'Credit Card',
    paymentStatus: 'Paid',
    orderStatus: 'Processing',
    shippingAddress: '200 Example Road',
    city: 'Hyderabad',
    state: 'Telangana',
    pincode: '500001',
    orderDate: '2026-03-04 11:05',
    courierName: 'Express Courier',
    trackingNumber: 'TRK-88992019',
  },
  {
    id: 'ord-1003',
    orderNumber: 'PC-ORD-2026-8803',
    customerName: 'Demo Customer C',
    email: 'demo-customer-3@example.invalid',
    phone: '+1-555-0153',
    items: [
      { title: 'Beyond the Horizon', quantity: 3, price: 449, format: 'Paperback' },
    ],
    totalAmount: 1347,
    paymentMethod: 'Net Banking',
    paymentStatus: 'Paid',
    orderStatus: 'Shipped',
    shippingAddress: '300 Fictional Boulevard',
    city: 'Kolkata',
    state: 'West Bengal',
    pincode: '700001',
    orderDate: '2026-03-03 16:45',
    courierName: 'Global Cargo',
    trackingNumber: 'TRK-441029',
  },
  {
    id: 'ord-1004',
    orderNumber: 'PC-ORD-2026-8804',
    customerName: 'Demo Customer D',
    email: 'demo-customer-4@example.invalid',
    phone: '+1-555-0154',
    items: [
    ...
    shippingAddress: '400 Test Street',
    city: 'Pune',
    state: 'Maharashtra',
    pincode: '411001',
    orderDate: '2026-03-01 09:12',
    courierName: 'Postal Service',
    trackingNumber: 'TRK-9901238',
  },
];
